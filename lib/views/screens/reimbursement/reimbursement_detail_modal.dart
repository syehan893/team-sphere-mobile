...
class ReimbursementDetailModalState extends State<ReimbursementDetailModal> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<CreateReimbursementRequestCubit,
      ...
      listener: (context, state) {
        ...
        if (state.updateStatus == CreationStatus.error) {
          CustomToast.showToast(
              context, 'Reimbursement Approval failed', TSColors.alert.red700);
          Navigator.of(context).pop();
        }
      },
